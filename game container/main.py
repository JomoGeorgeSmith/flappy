...
# Define the paths to the images relative to the executable directory
BIRD_PATHS = [
    os.path.join(exe_dir, "imgs", "bird1.png"),
    os.path.join(exe_dir, "imgs", "bird2.png"),
    os.path.join(exe_dir, "imgs", "bird3.png")
]

PIPE_PATH = os.path.join(exe_dir, "imgs", "pipe.png")
BASE_PATH = os.path.join(exe_dir, "imgs", "base.png")
BG_PATH = os.path.join(exe_dir, "imgs", "bg.png")

# Load the images
BIRD_IMGS = [pygame.transform.scale2x(pygame.image.load(path)) for path in BIRD_PATHS]
PIPE_IMGS = [pygame.transform.scale2x(pygame.image.load(PIPE_PATH))]
BASE_IMGS = [pygame.transform.scale2x(pygame.image.load(BASE_PATH))]
BG_IMGS = [pygame.transform.scale2x(pygame.image.load(BG_PATH))]
...
def main(genomes, config):
    ...
    if ee:
            trained_genomes_filename = os.path.join(exe_dir, "trained_genome.pkl")
    ...
    while run:
        ...
        if score > 0 and score % 10 == 0:
            genome_sent = False
            send_genome(os.path.join(exe_dir, "trained_genome.pkl"), host, port_send)
            # save current winner
